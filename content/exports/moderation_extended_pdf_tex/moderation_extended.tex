...
\author[1,2]{Christopher D. Carroll}\ead{ccarroll@jhu.edu}\author[3]{Karsten Chipeniuk}\author[1,2]{Alan Lujan\corref{cor1}}\ead{alujan@jhu.edu}\author[4]{Kiichi Tokuoka}\author[5]{Weifeng Wu}
...
`realist' consumer, who \textit{does} perceive the risks, will engage in
...
\section{Benchmark: The Method of Endogenous Gridpoints}\label{benchmark-the-method-of-endogenous-gridpoints}
...
\subsection{The Consumption Function}\label{the-consumption-function}
